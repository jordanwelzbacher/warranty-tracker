...
const WarrantyForm = () => {
  ...
  // const fetchWarrantyAndTypes = () => {
  //   const warrantyData = id ? WarrantyService.getById(id) : null;
  //   const typesData = IssuerTypeService.getTypes();
  //   let w = null;
  //   let t = null;

  //   if (warrantyData) {
  //     Promise.all([warrantyData, typesData])
  //       .then((responses) => {
  //         setWarranty(responses[0].data)
  //         setWarranty((stateW) => {
  //           w = stateW.warranty
  //           setIssuerTypes(responses[1].data)
  //           setIssuerTypes((stateT) => {
  //             t = stateT.issuerTypes
  //             fillInForm(stateW.warranty, t)
  //           })
  //         })
  ...
  //   }
  //   else {
  //     Promise.all([typesData]).then((responses) => {
  //       setIssuerTypes(responses[0].data)
  //       setIssuerTypes((stateT) => {
  //         t = stateT.issuerTypes
  //         fillInForm(null, t)
  //       })
